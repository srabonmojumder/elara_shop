...
const stores: Store[] = [
  {
    ...
    services: ["Personal styling", "Tailoring services", "Style bar", "Personal shopping"],
    rating: 4.9,
    reviews: 1284,
    openedYear: 2022,
    square: "420m²",
    tags: ["Flagship", "Tailoring atelier"],
    featured: true,
  },
  {
    city: "Paris",
    ...
    services: ["Personal styling", "Made-to-measure", "Personal shopping"],
    rating: 4.8,
    reviews: 642,
    openedYear: 2023,
    square: "280m²",
  ...
  },
  {
    ...
    services: ["Personal styling", "Tailoring services", "Style bar", "Made-to-measure", "Personal shopping"],
    rating: 4.9,
    reviews: 918,
    openedYear: 2024,
    square: "360m²",
  ...
  },
  {
    ...
    services: ["Personal styling", "Tailoring services", "Personal shopping"],
    rating: 4.7,
    reviews: 433,
    openedYear: 2024,
    square: "220m²",
  ...
  },
  {
    ...
    image: "/images/hero/hero-1.jpg",
    services: ["Personal styling", "Tailoring services", "Style bar"],
    rating: 4.8,
    reviews: 287,
    openedYear: 2025,
    square: "260m²",
  ...
  },
  {
    ...
    todayHours: "Open until 20:00",
    image: "/images/hero/hero-2.jpg",
    services: ["Personal styling", "Style bar", "Personal shopping"],
    rating: 4.7,
    reviews: 204,
    openedYear: 2025,
    square: "240m²",
...
const services = [
  {
    ...
    detail: "A 30-minute session with one of our stylists — colour, fit, and a capsule plan tailored to how you actually live. Always free.",
    duration: "30 min",
    price: "Complimentary",
  },
  {
    icon: Palette,
    title: "Tailoring Atelier",
    detail: "Hemming, alterations, and fittings handled in-house by master tailors. Same-week turnaround on most pieces.",
    duration: "45 min",
    price: "From €25 / piece",
  },
  {
    icon: Wine,
    title: "Style Lounge",
    detail: "Browse new arrivals over a glass of something nice. Our stylists pull pieces in your size, you decide what works.",
    duration: "60 min",
    price: "Complimentary",
  },
];
