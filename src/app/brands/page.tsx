...
const spotlight = [
  {
    name: "Atelier Nord",
    slug: "atelier-nord",
    image: "/images/brands/atelier-nord.jpg",
    tagline: "Scandinavian minimalism, hand-finished",
    category: "Womenswear",
    since: "2014",
  },
  {
    name: "Mira & Co",
    slug: "mira-co",
    image: "/images/brands/mira-co.jpg",
    tagline: "French boutique, modern silhouettes",
    category: "Womenswear",
    since: "2017",
  },
  {
    name: "Linea",
    slug: "linea",
    image: "/images/brands/linea.jpg",
    tagline: "Italian leather, made the slow way",
    category: "Footwear",
    since: "1992",
  },
  {
    name: "Heloise",
    slug: "heloise",
    image: "/images/brands/heloise.jpg",
    tagline: "Parisian fine jewelry",
    category: "Jewelry",
    since: "2009",
  },
];
...
const allBrands: Brand[] = [
  { name: "Atelier Nord", category: "Womenswear", country: "DK", badge: "editor", tagline: "Scandinavian minimalism, hand-finished" },
  { name: "Auralee", category: "Menswear", country: "JP", badge: "cult", tagline: "Soft tailoring, considered fabric" },
  { name: "Birkenstock", category: "Footwear", country: "DE", tagline: "Comfort, made the original way" },
  { name: "Cassis", category: "Bags", country: "FR", badge: "editor", tagline: "French leather, structured silhouettes" },
  { name: "Cos", category: "Womenswear", country: "SE", tagline: "Modern essentials, considered design" },
  { name: "Common Projects", category: "Footwear", country: "IT", badge: "cult", tagline: "The white sneaker, perfected" },
  { name: "Dries Van Noten", category: "Womenswear", country: "BE", tagline: "Print, color, character" },
  { name: "Drake's", category: "Menswear", country: "UK", badge: "editor", tagline: "Savile Row, modernised" },
  { name: "Everlane", category: "Womenswear", country: "US", badge: "clean", tagline: "Radical transparency" },
  { name: "Filson", category: "Menswear", country: "US", tagline: "Built for a lifetime" },
  { name: "Frame", category: "Womenswear", country: "US", tagline: "California denim, French sensibility" },
  { name: "Heloise", category: "Jewelry", country: "FR", badge: "editor", tagline: "Parisian fine jewelry" },
  { name: "Hermès", category: "Bags", country: "FR", badge: "editor", tagline: "Craft, continued since 1837" },
  { name: "Issey Miyake", category: "Womenswear", country: "JP", tagline: "Pleats, geometry, movement" },
  { name: "Jacquemus", category: "Womenswear", country: "FR", badge: "cult", tagline: "Provence, on the runway" },
  { name: "Jenni Kayne", category: "Home", country: "US", tagline: "California easy, considered home" },
  { name: "Khaite", category: "Womenswear", country: "US", badge: "editor", tagline: "American luxury, redefined" },
  { name: "Kindred", category: "Home", country: "UK", badge: "clean", tagline: "Modern essentials for the home" },
  { name: "Levi's", category: "Womenswear", country: "US", tagline: "501s, since 1873" },
  { name: "Loro Piana", category: "Womenswear", country: "IT", badge: "editor", tagline: "Cashmere from the source" },
  { name: "Linea", category: "Footwear", country: "IT", tagline: "Italian leather, hand-stitched" },
  { name: "Lemaire", category: "Womenswear", country: "FR", badge: "editor", tagline: "Quiet, timeless, Parisian" },
  { name: "Mansur Gavriel", category: "Bags", country: "US", tagline: "Leather, distilled" },
  { name: "Mejuri", category: "Jewelry", country: "CA", badge: "cult", tagline: "Fine jewelry for everyday" },
  { name: "Mira & Co", category: "Womenswear", country: "FR", badge: "cult", tagline: "French boutique, modern cut" },
  { name: "Nanushka", category: "Womenswear", country: "HU", tagline: "Vegan leather, contemporary" },
  { name: "Nudie Jeans", category: "Womenswear", country: "SE", badge: "clean", tagline: "Repaired, recycled, reused" },
  { name: "Officine Générale", category: "Menswear", country: "FR", tagline: "Parisian tailoring, easy fits" },
  { name: "Polly & Bea", category: "Jewelry", country: "UK", tagline: "Hand-finished demi-fine" },
  { name: "Patagonia", category: "Menswear", country: "US", badge: "clean", tagline: "Built to outlast you" },
  { name: "Reformation", category: "Womenswear", country: "US", badge: "clean", tagline: "Sustainable, sexy, simple" },
  { name: "Rains", category: "Bags", country: "DK", tagline: "Scandinavian rainwear, refined" },
  { name: "Rejina Pyo", category: "Womenswear", country: "UK", badge: "new", tagline: "Sculptural, wearable" },
  { name: "Saoirse", category: "Footwear", country: "IE", badge: "new", tagline: "Irish craft, modern silhouettes" },
  { name: "Studio Nicholson", category: "Womenswear", country: "UK", badge: "editor", tagline: "Modular tailoring" },
  { name: "Sézane", category: "Womenswear", country: "FR", badge: "cult", tagline: "Online-only Parisian" },
  { name: "Toteme", category: "Womenswear", country: "SE", badge: "editor", tagline: "Scandinavian luxe, neutral palette" },
  { name: "Tekla", category: "Home", country: "DK", tagline: "Slow textiles for the home" },
  { name: "The Frankie Shop", category: "Womenswear", country: "US", badge: "cult", tagline: "Power blazers, oversized everything" },
  { name: "The Row", category: "Womenswear", country: "US", badge: "editor", tagline: "Quiet luxury, defined" },
  { name: "Verda", category: "Menswear", country: "PT", badge: "clean", tagline: "Sustainable basics, Portuguese-made" },
  { name: "Veja", category: "Footwear", country: "FR", badge: "clean", tagline: "Eco sneakers, transparent supply" },
];
